...
<h3>Person Record: <?php print sprintf("%s %s", $person->first_name, $person->last_name);?></h3>
...
<div class="content">
	<div
		...
		<div class='field-set'>
	<?php print create_field("first_name", get_value($person, "first_name"), "First Name",array("envelope"=>"div"));?>
</div>
		<div class='field-set'>
	<?php print create_field("last_name", get_value($person,"last_name"), "Last Name",array("envelope"=>"div"));?>
</div>
		<div class='field-set'>
	<?php print create_field("email", get_value($person,"email"), "Email",array("envelope"=>"div","format"=>"email"));?>
</div>
		<div class='field-set'>
	<?php print create_field("shirt_size", get_value($person,"shirt_size"), "Shirt Size",array("envelope"=>"div","class"=>"dropdown","attributes"=>"menu='shirt_size'"));?>
</div>
<div class='field-set'>
...
<input type="checkbox" value="1" id="is_veteran" name="is_veteran" <?php print get_value($person, "is_veteran", FALSE) ? "checked" : "";?>/>
...
<div class="block housemate-info"
    ...
    <tr>
    					<td><a href="<?php print site_url("person/view/$housemate->id");?>"><?php print sprintf("%s %s", $housemate->first_name,$housemate->last_name);?></a></td>
    				</tr>
    <?php endforeach; ?>
    </table>
    <?php endif;?>
    <?php print create_button_bar(array(array("text" => "Add Housemate", "type"=>"span", "class"=>"button small new add-housemate","id"=>sprintf("add-housemate_%s_%s",$person->id, $person->address->id))));?>
</div>
<?php else: ?>
