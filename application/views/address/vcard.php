...
<?php endforeach; ?>
ADR;TYPE=HOME:;;<?php print $person->address->address; ?>;<?php print $person->address->city; ?>;<?php print $person->address->state; ?>;<?php print $person->address->zip; ?>;United States of America

EMAIL;TYPE=INTERNET:<?php print $person->email; ?>
