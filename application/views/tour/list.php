	...
	<table class="list">
		...
		<tr class="<?php print $row_class; ?>">
			...
			<?php if ($for_tourist): ?>
				...
				<td>
					<a href="<?php print site_url("payer/edit/?payer_id=$tour->payer_id&tour_id=$tour->tour_id"); ?>"
			...
			<?php else: ?>
				<td><a
							...
							href="<?php print site_url("/hotel/view_all/$tour->id"); ?>">Hotels</a>
				</td>
				<td><a
				...
				<td><a
							class="button show-letters small dialog"
