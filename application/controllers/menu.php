...
class Menu extends MY_Controller
	{
		...
		{
			parent::__construct ();
			$this->load->model ( "variable_menu", "variable" );
		}
		...
		function edit_value ()
		{
			...
			switch ($data ["type"]) {
				...
				case "email" :
					...
					break;
				case "date" :
					$output = sprintf ( "<input type='text' class='datefield' name=%s' id='%s' value='%s' size='%s'/>", $data ['name'], $data ['id'], $data ['value'], $data ['size'] );
					break;
				default :
