...
<div
	...
	id="hotel-info"
	style="clear: both">
	<div class="hotel-name field-set">
		<label>Hotel:&nbsp;</label><a
			href="<?php print site_url('hotel/view/' . $hotel->id); ?>"><?php print $hotel->hotel_name ?></a>
	</div>
	...
	<?php if (get_value($hotel, "contact", FALSE)): ?>
		<div class="field-set">
			...
			<label>Contact
				Info: </label><?php print get_value($hotel, "contact"); ?></div>
	<?php endif; ?>
